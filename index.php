        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    ...
                    <a href="#" type="button" class="btn button-primary-violet btn-slide">Подробнее</a>
                </div>
            </div>
...
<section class="doctor-list-block">
    <div class="container">
        ...
        <div class="container">
            <a href="#" type="button" class="btn button-primary-violet   but-spec">Все специалисты клиники</a>
        </div>
    </div>
</section>
...
<section class="about-block container">
    ...
    <div class="row">
        ...
        <div class="col-sm">
            ...
            <a href="about.php" type="button" class="btn button-primary-violet   button-about">ПОДРОБНЕЕ</a>
        </div>
    </div>
</section>
